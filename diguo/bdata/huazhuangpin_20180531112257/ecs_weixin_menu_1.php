...
E_D("replace into `ecs_weixin_menu` values('1','click','1','商城首页','','0');");
E_D("replace into `ecs_weixin_menu` values('2','click','1','会员中心','','0');");
E_D("replace into `ecs_weixin_menu` values('3','click','1','会员福利','','0');");
...
E_D("replace into `ecs_weixin_menu` values('7','view','2','进入首页','http://www.0769web.net/wechat/oauth/wxch_oauth.php?oid=1','1');");
...
E_D("replace into `ecs_weixin_menu` values('11','view','2','分销中心','http://www.0769web.net/wechat/oauth/wxch_oauth.php?oid=14','2');");
...
E_D("replace into `ecs_weixin_menu` values('14','click','2','签到送积分','qiandao','3');");
E_D("replace into `ecs_weixin_menu` values('15','click','2','砸金蛋','zjd','3');");
E_D("replace into `ecs_weixin_menu` values('16','click','2','大转盘','dzp','3');");
E_D("replace into `ecs_weixin_menu` values('17','click','2','','','3');");
E_D("replace into `ecs_weixin_menu` values('18','click','2','','','3');");
