...
E_D("replace into `ecs_weixin_prize_append` values('7','1','送男朋友','10');");
E_D("replace into `ecs_weixin_prize_append` values('8','1','女朋友','10');");
E_D("replace into `ecs_weixin_prize_append` values('9','1','充气娃娃','10');");
