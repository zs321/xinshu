...
E_D("replace into `ecs_touch_nav` values('2','','0','预售活动','1','0','0','pre_sale.php','1448075935109557161.png','middle');");
...
E_D("replace into `ecs_touch_nav` values('6','','0','精品团购','1','0','0','group_buy.php','1443585779204202237.png','middle');");
E_D("replace into `ecs_touch_nav` values('7','','0','积分商城','1','0','0','exchange.php','1443586061863736586.png','middle');");
E_D("replace into `ecs_touch_nav` values('8','','0','限时秒杀','1','0','0','pre_spike.php','1443584408064043342.png','middle');");
