...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','化妆品商城','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','化妆品商城','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','化妆品商城','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','化妆品商城','1');");
...
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','79','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','光明大道千栩大厦','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','782869779','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','东莞青蜂网络','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','kefu@0769web.net','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','15916852053','1');");
E_D("replace into `ecs_shop_config` values('116','1','shop_closed','select','0,1','','0','1');");
E_D("replace into `ecs_shop_config` values('117','1','close_comment','textarea','','','商城盘点中，请稍后','1');");
E_D("replace into `ecs_shop_config` values('118','1','shop_logo','file','','../themes/{\$template}/images/','../themes/huazhuangpin/images/logo.gif','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','粤ICP备12061602号','1');");
...
E_D("replace into `ecs_shop_config` values('206','2','watermark_alpha','text','','','50','1');");
...
E_D("replace into `ecs_shop_config` values('210','2','integral_name','text','','','金币','1');");
E_D("replace into `ecs_shop_config` values('211','2','integral_scale','text','','','1','1');");
E_D("replace into `ecs_shop_config` values('212','2','integral_percent','text','','','100','1');");
E_D("replace into `ecs_shop_config` values('213','2','sn_prefix','text','','','MDZ','1');");
...
E_D("replace into `ecs_shop_config` values('219','2','cache_time','text','','','1800','1');");
E_D("replace into `ecs_shop_config` values('220','2','register_points','text','','','5','1');");
...
E_D("replace into `ecs_shop_config` values('229','2','default_storage','text','','','500','1');");
...
E_D("replace into `ecs_shop_config` values('241','2','certi','hidden','','','http://www.0769web.net/','1');");
...
E_D("replace into `ecs_shop_config` values('303','3','currency_format','text','','','<font>￥%s</font>','1');");
E_D("replace into `ecs_shop_config` values('304','3','thumb_width','text','','','500','1');");
E_D("replace into `ecs_shop_config` values('305','3','thumb_height','text','','','500','1');");
...
E_D("replace into `ecs_shop_config` values('325','3','article_title_length','text','','','50','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','保湿面膜,洗面奶,补水,香水,眼霜,口红,护肤套装,BB霜','0');");
...
E_D("replace into `ecs_shop_config` values('334','3','article_page_size','text','','','5','1');");
...
E_D("replace into `ecs_shop_config` values('417','4','order_cancel_note','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('418','4','invoice_content','textarea','','','购物清单','1');");
...
E_D("replace into `ecs_shop_config` values('422','4','invoice_type','manual','','','a:2:{s:4:\"type\";a:3:{i:0;s:41:\"增值税普通发票(小规模纳税人)\";i:1;s:38:\"增值税专用发票(一般纳税人)\";i:2;s:0:\"\";}s:4:\"rate\";a:3:{i:0;d:1.5;i:1;d:3;i:2;d:0;}}','1');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','huazhuangpin','1');");
...
E_D("replace into `ecs_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:7:{s:6:\"expire\";d:24;s:11:\"expire_unit\";s:4:\"hour\";s:11:\"separate_by\";i:0;s:15:\"level_point_all\";s:2:\"5%\";s:15:\"level_money_all\";s:2:\"1%\";s:18:\"level_register_all\";i:2;s:17:\"level_register_up\";i:50;}s:4:\"item\";a:4:{i:0;a:2:{s:11:\"level_point\";s:3:\"60%\";s:11:\"level_money\";s:3:\"60%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"30%\";s:11:\"level_money\";s:3:\"30%\";}i:2;a:2:{s:11:\"level_point\";s:2:\"7%\";s:11:\"level_money\";s:2:\"7%\";}i:3;a:2:{s:11:\"level_point\";s:2:\"3%\";s:11:\"level_money\";s:2:\"3%\";}}s:2:\"on\";i:0;}','1');");
E_D("replace into `ecs_shop_config` values('617','6','captcha','hidden','','','47','1');");
...
E_D("replace into `ecs_shop_config` values('9001','9011','ecsdxt_gateway','options','1,2','','1','1');");
E_D("replace into `ecs_shop_config` values('9002','90','ecsdxt_user_name','text','','','limingsheng','1');");
E_D("replace into `ecs_shop_config` values('9003','90','ecsdxt_pass_word','password','','','111222','1');");
E_D("replace into `ecs_shop_config` values('9004','90','ecsdxt_shop_mobile','text','','','15916852053','1');");
E_D("replace into `ecs_shop_config` values('9005','90','ecsdxt_smsgap','text','','','60','1');");
E_D("replace into `ecs_shop_config` values('9006','90','ecsdxt_mobile_reg','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('9007','90','ecsdxt_mobile_reg_value','textarea','','','您的手机号：{\$user_mobile}，注册验证码：{\$verify_code}，24小时内提交有效。感谢您的注册！','1');");
...
E_D("replace into `ecs_shop_config` values('1019','1','okback_time','text','','','3','1');");
E_D("replace into `ecs_shop_config` values('1020','1','delback_time','text','','','3','1');");
E_D("replace into `ecs_shop_config` values('1021','1','weixiu_time','text','','','2','1');");
E_D("replace into `ecs_shop_config` values('9040','1','kuaidi100','text','','','http://www.kuaidi100.com/query?type=%s&postid=%s&id=19&valicode=&temp=0.9624486646937056','1');");
E_D("replace into `ecs_shop_config` values('9100','9011','ecsdxt_sign','text','','','青蜂网络','0');");
