<?php exit;?>a:3:{s:8:"template";a:6:{i:0;s:72:"D:/phpStudy/PHPTutorial/WWW/xinshu/themes/huazhuangpin/pre_sale_list.dwt";i:1;s:78:"D:/phpStudy/PHPTutorial/WWW/xinshu/themes/huazhuangpin/library/page_header.lbi";i:2;s:74:"D:/phpStudy/PHPTutorial/WWW/xinshu/themes/huazhuangpin/library/ur_here.lbi";i:3;s:72:"D:/phpStudy/PHPTutorial/WWW/xinshu/themes/huazhuangpin/library/pages.lbi";i:4;s:78:"D:/phpStudy/PHPTutorial/WWW/xinshu/themes/huazhuangpin/library/page_footer.lbi";i:5;s:80:"D:/phpStudy/PHPTutorial/WWW/xinshu/themes/huazhuangpin/library/right_sidebar.lbi";}s:7:"expires";i:1532326455;s:8:"maketime";i:1532324655;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <ul class="nav-items">
	            	<li>
	            		...
	            		<a href="exchange.php"    rel="nofollow">积分兑换</a>
			            	...
			            	<li>
	            		<a href="pre_sale.php"    class="cur" rel="nofollow">杏树认购</a>
	            	</li>
			            	<li>
...
<div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="pre_sale.php">预售活动</a></div><div class="main cle">
							...
							<div class="pic" id="li_75">
								<a href="pre_sale.php?id=1" target="_blank"> <img title="玫琳凯 心语香水29ml 女士香水 花果香型" alt="玫琳凯 心语香水29ml 女士香水 花果香型" width=220 height=220 data-original="images/no_picture.gif" src="themes/huazhuangpin/images/spacer.gif" class="loading pic_img_75"></a> 							</div>
							<div class="shijian" id="shijian1_0">
								<i></i> <span id="ps_label_75" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_75" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
							...
							<div class="title">
								<a title="玫琳凯 心语香水29ml 女士香水 花果香型" href="pre_sale.php?id=1" target="_blank">玫琳凯 心语香水29ml 女士香水 花果香型</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span><font>￥36.00</font></span><span class="yp"></span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_75" href="javascript:collect(75); re_collect(75)">收藏</a>
								</div>
								<div class="n-tg">
			            ...
			            $(function(){
			              $("#shijian_0").mouseenter(function(){
			            	  	var isover = $("#ps_label_75").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_75").show();
			              ...
			              $("#shijian_0").mouseleave(function(){
							...
							<div class="pic" id="li_67">
								<a href="pre_sale.php?id=2" target="_blank"> <img title="Loreal欧莱雅 透明质酸洗护套装（洗发水400ml+护发素200ml）无硅油洗发" alt="Loreal欧莱雅 透明质酸洗护套装（洗发水400ml+护发素200ml）无硅油洗发" width=220 height=220 data-original="images/no_picture.gif" src="themes/huazhuangpin/images/spacer.gif" class="loading pic_img_67"></a> 							</div>
							...
							<div class="title">
								<a title="Loreal欧莱雅 透明质酸洗护套装（洗发水400ml+护发素200ml）无硅油洗发" href="pre_sale.php?id=2" target="_blank">Loreal欧莱雅 透明质酸洗护套装（洗发水400ml+护发素200ml）无硅油洗发</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span><font>￥30.00</font></span><span class="yp"></span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
			            ...
			            $(function(){
			              ...
			              $("#shijian_1").mouseleave(function(){
							...
							<div class="pic" id="li_64">
								<a href="pre_sale.php?id=3" target="_blank"> <img title="泊泉雅 马油保湿润肤身体乳 250g 滋润舒缓肌肤" alt="泊泉雅 马油保湿润肤身体乳 250g 滋润舒缓肌肤" width=220 height=220 data-original="images/no_picture.gif" src="themes/huazhuangpin/images/spacer.gif" class="loading pic_img_64"></a> 							</div>
							<div class="shijian" id="shijian1_2">
								<i></i> <span id="ps_label_64" style="text-align: center;" over="false">预售中</span> <span id="ps_cd_64" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
							...
							<div class="title">
								<a title="泊泉雅 马油保湿润肤身体乳 250g 滋润舒缓肌肤" href="pre_sale.php?id=3" target="_blank">泊泉雅 马油保湿润肤身体乳 250g 滋润舒缓肌肤</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span><font>￥20.00</font></span><span class="yp"></span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_64" href="javascript:collect(64); re_collect(64)">收藏</a>
								</div>
								<div class="n-tg">
			            ...
			            $(function(){
			              $("#shijian_2").mouseenter(function(){
			            	  	var isover = $("#ps_label_64").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_64").show();
