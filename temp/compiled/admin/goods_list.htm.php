...
?>
  <tr>
    ...
    <td class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><?php if ($this->_var['goods']['is_sale']): ?><font color=blue>【秒杀中】</font><?php endif; ?><span onclick="listTable.edit(this, 'edit_goods_name', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></span></td>
