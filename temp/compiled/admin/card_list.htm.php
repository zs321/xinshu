...
?>
  <tr>
    ...
    <?php if ($this->_var['card']['card_img']): ?>
        <a href = "../data/cardimg/<?php echo $this->_var['card']['card_img']; ?>" target="_brank"><img src="images/picflag.gif" width="21" height="21" border="0" alt="" /></a>
    <?php else: ?>
        <img src="images/picnoflag.gif" width="21" height="21" border="0" alt="" />
    <?php endif; ?>
    </td>
