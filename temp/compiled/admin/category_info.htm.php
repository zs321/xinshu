...
<div class="main-div">
 ...
 <td>
  <textarea name='cat_name' rows="6" cols="48"><?php echo htmlspecialchars($this->_var['cat_info']['cat_name']); ?></textarea> <font color="red">*</font>
  <span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="noticeCat_name">一次可添加多个分类，一行一个</span>
 </td>
</tr>
      <tr>
