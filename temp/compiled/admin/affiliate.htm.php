...
<form method="post" action="affiliate.php">
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
                ...
                <tr>
                    <td width="20%" align="right" class="label"><a href="javascript:showNotice('notice1');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['expire']; ?> </td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice2');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_point_all']; ?> </td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice3');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_money_all']; ?> </td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice4');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_register_all']; ?></td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice5');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_register_up']; ?></td>
