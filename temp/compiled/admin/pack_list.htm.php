...
?>
    <tr>
      <td class="first-cell">
        <?php if (( $this->_var['pack']['pack_img'] )): ?><a href = "../data/packimg/<?php echo $this->_var['pack']['pack_img']; ?> " target="_brank"><img src="images/picflag.gif" width="21" height="21" border="0" alt="" /></a><?php else: ?><img src="images/picnoflag.gif" width="21" height="21" border="0" alt="" /><?php endif; ?>
