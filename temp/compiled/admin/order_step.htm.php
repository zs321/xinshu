...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/utils.js,transport_jquery.js,validator.js')); ?>
...
?>
  ...
  <tr>
    <td colspan="3"><a href="javascript:showNotice('noticeinvoiceno');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><strong><?php echo $this->_var['lang']['label_invoice_no']; ?></strong><input name="invoice_no" type="text" value="<?php echo $this->_var['order']['invoice_no']; ?>" size="30"/><br/><span class="notice-span" id="noticeinvoiceno" style="display:block;"><?php echo $this->_var['lang']['invoice_no_mall']; ?></span></td>
  </tr>
</table>
</div>
