  ...
  <div id="tabbody-div">
    ...
    <table width="90%" id="general-table">
      <tr>
        ...
        <td><input type="text" name="title" size ="40" value="<?php echo htmlspecialchars($this->_var['article']['title']); ?>" /><?php echo $this->_var['lang']['require_field']; ?></td>
      </tr>          
      ...
      <tr>
        ...
        <td><input type="text" name="author" value="<?php echo htmlspecialchars($this->_var['article']['author']); ?>" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['email']; ?></td>
        <td><input type="text" name="author_email" value="<?php echo htmlspecialchars($this->_var['article']['author_email']); ?>" /></td>
      </tr>
      <tr>
        <td class="narrow-label"><?php echo $this->_var['lang']['keywords']; ?></td>
        <td><input type="text" name="keywords" value="<?php echo htmlspecialchars($this->_var['article']['keywords']); ?>" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="link_url" type="text" id="link_url" value="<?php if ($this->_var['article']['link'] != ''): ?><?php echo htmlspecialchars($this->_var['article']['link']); ?><?php else: ?>http://<?php endif; ?>" /></td>
      </tr>
      <tr>
