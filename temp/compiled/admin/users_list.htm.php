...
<div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
    ...
    &nbsp;<?php echo $this->_var['lang']['label_user_name']; ?> &nbsp;<input type="text" name="keyword" id="keyword" /> <input type="submit" class="button" value="<?php echo $this->_var['lang']['button_search']; ?>" /><input type="button" class="button" value="导出会员" onclick="user_to_excel()" />
  </form>
</div>
