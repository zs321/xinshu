...
<style type="text/css">
input[type='password']{margin: 5px; padding: 0px 4px;}
</style>
...
<td class="dl">
     ...
     <tr class="low_height">
        <td>&nbsp;</td>
        <td><input type="checkbox" value="1" name="remember" id="remember" checked="checked" /><label for="remember" ><?php echo $this->_var['lang']['remember']; ?></label></td></tr>
      <tr>
