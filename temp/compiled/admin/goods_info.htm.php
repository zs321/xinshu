...
?>
          ...
          <tr>
            <td class="label"><label for="is_sale"><input type="checkbox" id="is_sale" name="is_sale" value="1" <?php if ($this->_var['goods']['is_sale']): ?>checked="checked"<?php endif; ?> onclick="handlesale(this.checked);" /> <?php echo $this->_var['lang']['lab_sale_price']; ?></label></td>
            <td id="sale_3"><input type="text" id="sale_1" name="sale_price" value="<?php echo $this->_var['goods']['sale_price']; ?>" size="20" /></td>
          </tr>
			<tr>
            <td class="label" >限购数量：</td>
            <td id="promote_3"><input type="text" id="buymax" name="buymax" value="<?php echo $this->_var['goods']['buymax']; ?>" size="20" /><br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="giveIntegral">表示秒杀日期内，每个用户最多只能购买多少件。0：表示不限购</span></td>
          </tr>
          <tr id="sale_4">
            <td class="label" id="sale_5"><?php echo $this->_var['lang']['lab_sale_date']; ?></td>
            <td id="sale_6">
              <input name="sale_start_date" type="text" id="sale_start_date" size="20" value='<?php echo $this->_var['goods']['sale_start_date']; ?>' readonly="readonly" /><input name="selbtn12" type="button" id="selbtn12" onclick="return showCalendar('sale_start_date', '%Y-%m-%d  %H:%M','24', false, 'selbtn12');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/> - <input name="sale_end_date" type="text" id="sale_end_date" size="20" value='<?php echo $this->_var['goods']['sale_end_date']; ?>' readonly="readonly" /><input name="selbtn22" type="button" id="selbtn22" onclick="return showCalendar('sale_end_date', '%Y-%m-%d  %H:%M','24', false, 'selbtn22');" value="<?php echo $this->_var['lang']['btn_select']; ?>" class="button"/>
            </td>
          </tr>
          <tr>
