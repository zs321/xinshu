...
class zto
{
    ...
    function kuaidi100($invoice_sn){
       // $url = 'http://m.kuaidi100.com/query?type=zhongtong&id=1&postid=' .$invoice_sn. '&temp='.time();
    	//$url = 'http://api.kuaidi100.com/api?id=29833628d495d7a5&com=zhongtong&nu=' .$invoice_sn. '&show=0&muti=1&order=desc';
		$url = sprintf($GLOBALS['_CFG']['kuaidi100'],'zhongtong',$invoice_sn);
    	return $url;
    }
}
