...

{
	...
	if($c)
	{
		...
		if( $type=='weixin' ) {
			...
			$url ='https://open.weixin.qq.com/connect/oauth2/authorize?appid='.WX_AKEY.'&redirect_uri='.urlencode($ecs->url().'accountbind.php?act=oath_login&type='.$type).'&response_type=code&scope=snsapi_base&state=1#wechat_redirect';
