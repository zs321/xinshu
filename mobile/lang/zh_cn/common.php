...
$_LANG['volume_price'] = '购买数量达到以下标准可享受的优惠';
...
$_LANG['pss'][PSS_PRE_START] = '后开始';
$_LANG['pss'][PSS_UNDER_WAY] = '后结束';
...
$_LANG['ps_error_login'] = '对不起，您没有登录，不能参加认购，请您先登录！';
$_LANG['ps_goods_empty'] = '当前没有预售活动';
$_LANG['ps_tree_num_empty'] = '对不起，您还没有杏树兑换资格！';

/* 秒杀部分语言项 */
$_LANG['pre_spike_goods'] = '限时秒杀';

/* 预售部分语言项 */
$_LANG['pre_sale_goods'] = '预售活动';
