<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:69:"D:/phpStudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/goods.dwt";i:1;s:89:"D:/phpStudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/goods_choose_attr.lbi";i:2;s:80:"D:/phpStudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/comments.lbi";i:3;s:83:"D:/phpStudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/page_footer.lbi";}s:7:"expires";i:1531973715;s:8:"maketime";i:1531971915;}<!DOCTYPE html>
<html>
<head>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>杏仁果酱_家用系列_杏树商城</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201807/thumb_img/132_thumb_G_1531875210507.jpg"  alt="杏仁果酱" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:100%;height:auto;" src="http://demo.0769web.net/ecshop/ecshop0541huazhuangpin/images/201807/goods_img/132_P_1531873883256.jpg" /></a></li>
         
              <li><a href="javascript:showPic()"><img style="width:100%;height:auto;" src="http://demo.0769web.net/ecshop/ecshop0541huazhuangpin/images/201807/goods_img/132_P_1531875210349.jpg" /></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo_title">
  ...
  <ul>
    <li>
         	<b class="price">￥<span>5.80</span></b>
...
<section class="goodsInfo_time">
		<script type="text/javascript" src="themes/huazhuangpin/js/jquery.countdown-2.5.3.min.js"></script>
		  <ul>
		    <li><span class="time_title">限时秒杀</span> <span class="time"><time class="countdown" id="timedown"><font id="ps_labels_132" over="false"></font><strong id="ps_cd_132" class="c_price">请稍等, 正在载入中...</strong><font id="ps_labele_132" over="false"></font></time></span> </li>
		  </ul>
		<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	var status = "1";
							$("#ps_labels_132").html("还剩");
							$("#ps_labele_132").html("结束");
				            					            					   	           	//if(132 == 62){
			...
			Ajax.call('index.php?act=clear_cache', 'POST', 'JSON');
					   	    				...
					   	    				$("#ps_cd_132").html("");
					   	    				//$("#ps_label_132").html("销售中");
					   	    				$("#zhuangtai132").removeClass("weikaishi");
					   	    				$("#zhuangtai132").addClass("jinxinzhong");
					   	    				$("#ps_labels_132").attr("over", true);
					   	    				$("#ps_labele_132").attr("over", true);
							$("#ps_labels_132").html("还剩");
							$("#ps_labele_132").html("结束");
					   	    				status = 1;
...
<section id="choose_good_user" style="height:0; overflow:hidden;">
    <section class="good_user_service">
        ...
        <ul>
	            <li>
                <p class="p_left">注册会员：￥<span>9.80</span></p>
	    </li>
	            <li>
                <p class="p_left">一星用户：￥<span>9.31</span></p>
	    </li>
	            <li>
                <p class="p_left">二星用户：￥<span>8.82</span></p>
	    </li>
		            <li>
...
<section id="choose_good_canshu" style="height:0; overflow:hidden;">
    <section class="good_canshu">
        ...
        <ul>
            <li>
                <p class="p_left">商品名称：</p><p class="p_right">杏仁果酱</p>
	    </li>
	                <li>
                <p class="p_left">商品编号：</p><p class="p_right">MDZ000132</p>
	    </li>
	    	    	                <li>
...
<img  id="ECS_GOODS_ATTR_THUMB" src="http://demo.0769web.net/ecshop/ecshop0541huazhuangpin/images/201807/thumb_img/132_thumb_G_1531875210507.jpg" style=" float:left;">
...
.spxq_main table td div, .spxq_main table td span {
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:132;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '111',
    timestamp: 1531971916,
    nonceStr: 'i95A2g4HAhj0Qsnn',
    signature: '12db2529e2270691b5e3f0cabf4f89f5b9027d10',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '杏仁果酱',
      link: '',
      imgUrl: 'http://demo.0769web.net/ecshop/ecshop0541huazhuangpin/images/201807/thumb_img/132_thumb_G_1531875210507.jpg',
...
function choose_attr(num){
	...
	$(".page_mask").show();
        if(num == 0){
            ...
            actionForm.action = "javascript:addToCart(132),close_choose_attr()";
        }
        if(num == 1){
            var actionForm = document.getElementById('ECS_FORMBUY');  
            actionForm.action = "javascript:addToCart_quick(132),close_choose_attr()";
        }
}
