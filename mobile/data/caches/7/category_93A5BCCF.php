<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:72:"D:/phpstudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/category.dwt";i:1;s:82:"D:/phpstudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/goods_list.lbi";i:2;s:83:"D:/phpstudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/page_footer.lbi";}s:7:"expires";i:1531901476;s:8:"maketime";i:1531899676;}<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<div class="filter" style="position:static; top:0px; width:100%;">
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=493&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list">销量 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
      ...
      <li class="filter-cur"> <a href="category.php?category=493&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=DESC#goods_list">价格 <span> <i class="f-ico-triangle-mt  f-ico-triangle-slctd"></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=493&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC'})
});
</script>
<script type="text/javascript">
