<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:69:"D:/phpstudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/goods.dwt";i:1;s:89:"D:/phpstudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/goods_choose_attr.lbi";i:2;s:80:"D:/phpstudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/comments.lbi";i:3;s:83:"D:/phpstudy/PHPTutorial/WWW/shop/mobile/themes/huazhuangpin/library/page_footer.lbi";}s:7:"expires";i:1531886014;s:8:"maketime";i:1531884214;}<!DOCTYPE html>
<html>
<head>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>淘米水沐浴露 滋润嫩滑 爽滑补水400ml_沐浴露_身体护理_个人护理_化妆品商城</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201707/thumb_img/71_thumb_G_1501045494772.jpg"  alt="淘米水沐浴露 滋润嫩滑 爽滑补水400ml" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:100%;height:auto;" src="http://demo.0769web.net/ecshop/ecshop0541huazhuangpin/images/201707/goods_img/71_P_1501045494944.jpg" /></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
  ...
  <a class="collect" id="collect_box" href="javascript:collect(71)" style="display: inline;"></a>
</section>
<script type="text/javascript">
TouchSlide({ 
	slideCell:"#slideBox",
...
<section class="goodsInfo_title">
  ...
  <ul>
    <li>
         	<b class="price">￥<span>34.80</span></b>
       
           <p class="xiaoliang">已售出 <span class="sales">25</span> </p>
    </li>
  </ul>
  <div class="blank1"></div>
  <h1> 淘米水沐浴露 滋润嫩滑 爽滑补水400ml </h1>
  <div class="blank1"></div>
    <div class="brief">
    品质保证 
  </div>
...
<section class="goodsInfo_time">
  <script type="text/javascript" src="data/static/js/lefttime.js"></script>  <ul>
    <li><span class="time_title">限时促销</span><span class="time"><time class="countdown" id="leftTime">请稍等, 正在载入中...</time></span> </li>
  </ul>
</section>
<div class="blank2"></div>
...
<section id="choose_good_user" style="height:0; overflow:hidden;">
    <section class="good_user_service">
        ...
        <ul>
	            <li>
                <p class="p_left">注册会员：￥<span>35.00</span></p>
	    </li>
	            <li>
                <p class="p_left">一星用户：￥<span>33.25</span></p>
	    </li>
	            <li>
                <p class="p_left">二星用户：￥<span>31.50</span></p>
	    </li>
		            <li>
                <p class="p_left">购买此商品可使用：3500积分</p>
	    </li>
			        </ul>
    </section>
...
<section id="choose_good_canshu" style="height:0; overflow:hidden;">
    <section class="good_canshu">
        ...
        <ul>
            <li>
                <p class="p_left">商品名称：</p><p class="p_right">淘米水沐浴露 滋润嫩滑 爽滑补水400ml</p>
	    </li>
	                <li>
                <p class="p_left">商品编号：</p><p class="p_right">MDZ000071</p>
	    </li>
	    	                <li>
                <p class="p_left">商品品牌：</p><p class="p_right"><a href="brand.php?id=14" >丹姿</a></p>
	    </li>
	    	                <li>
...
<img  id="ECS_GOODS_ATTR_THUMB" src="http://demo.0769web.net/ecshop/ecshop0541huazhuangpin/images/201707/thumb_img/71_thumb_G_1501045494772.jpg" style=" float:left;">
...
.spxq_main table td div, .spxq_main table td span {
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:71;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '111',
    timestamp: 1531884214,
    nonceStr: 'BhK5ann3lIfKaHLZ',
    signature: '1db9e8e924068b7c66f093410aaa0acdabddb74f',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '淘米水沐浴露 滋润嫩滑 爽滑补水400ml',
      desc: '淘米水沐浴露 滋润嫩滑 爽滑补水400ml',
      link: '',
      imgUrl: 'http://demo.0769web.net/ecshop/ecshop0541huazhuangpin/images/201707/thumb_img/71_thumb_G_1501045494772.jpg',
...
function choose_attr(num){
	...
	$(".page_mask").show();
        if(num == 0){
            ...
            actionForm.action = "javascript:addToCart(71),close_choose_attr()";
        }
        if(num == 1){
            var actionForm = document.getElementById('ECS_FORMBUY');  
            actionForm.action = "javascript:addToCart_quick(71),close_choose_attr()";
        }
}
