<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:71:"D:/phpStudy/PHPTutorial/WWW/xinshu/mobile/themes/huazhuangpin/goods.dwt";i:1;s:91:"D:/phpStudy/PHPTutorial/WWW/xinshu/mobile/themes/huazhuangpin/library/goods_choose_attr.lbi";i:2;s:82:"D:/phpStudy/PHPTutorial/WWW/xinshu/mobile/themes/huazhuangpin/library/comments.lbi";i:3;s:85:"D:/phpStudy/PHPTutorial/WWW/xinshu/mobile/themes/huazhuangpin/library/page_footer.lbi";}s:7:"expires";i:1532058158;s:8:"maketime";i:1532056358;}<!DOCTYPE html>
<html>
<head>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>杏仁果酒_保健品类_杏树商城</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201807/thumb_img/129_thumb_G_1531873754135.jpg"  alt="杏仁果酒" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:100%;height:auto;" src="/images/201807/goods_img/129_P_1531873754926.png" /></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
  ...
  <a class="collect" id="collect_box" href="javascript:collect(129)" style="display: inline;"></a>
</section>
<script type="text/javascript">
TouchSlide({ 
	slideCell:"#slideBox",
...
<section class="goodsInfo_title">
  ...
  <ul>
    <li>
   	<b class="price" >￥<span>10.00</span></b>
...
<section id="choose_good_user" style="height:0; overflow:hidden;">
    <section class="good_user_service">
        ...
        <ul>
	            <li>
                <p class="p_left">注册会员：￥<span>10.00</span></p>
	    </li>
	            <li>
                <p class="p_left">一星用户：￥<span>9.50</span></p>
	    </li>
	            <li>
                <p class="p_left">二星用户：￥<span>9.00</span></p>
	    </li>
		            <li>
...
<section id="choose_good_canshu" style="height:0; overflow:hidden;">
    <section class="good_canshu">
        ...
        <ul>
            <li>
                <p class="p_left">商品名称：</p><p class="p_right">杏仁果酒</p>
	    </li>
	                <li>
                <p class="p_left">商品编号：</p><p class="p_right">MDZ000129</p>
	    </li>
	    	    	                <li>
...
<img  id="ECS_GOODS_ATTR_THUMB" src="/images/201807/thumb_img/129_thumb_G_1531873754135.jpg" style=" float:left;">
...
.spxq_main table td div, .spxq_main table td span {
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:129;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '111',
    timestamp: 1532056363,
    nonceStr: 'Y226jl5khC9FjESk',
    signature: '8bbe64a06da4ef5b277fe05f11cfd6d91bd2a7bf',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '杏仁果酒',
      desc: '杏仁果酒',
      link: 'http://www.test666.com/mobile/goods.php?id=129&u=257',
      imgUrl: '/images/201807/thumb_img/129_thumb_G_1531873754135.jpg',
...
function choose_attr(num){
	...
	$(".page_mask").show();
        if(num == 0){
            ...
            actionForm.action = "javascript:addToCart(129),close_choose_attr()";
        }
        if(num == 1){
            var actionForm = document.getElementById('ECS_FORMBUY');  
            actionForm.action = "javascript:addToCart_quick(129),close_choose_attr()";
        }
}
