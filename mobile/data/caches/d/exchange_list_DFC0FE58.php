...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'exchange.php?act=asynclist&category=0&brand=&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/huazhuangpin/images/loader.gif" /></div>'})
	$(window).scroll(function () {
