...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      ...
      <li class="filter-cur"> <a href="exchange.php?category=0&display=grid&brand=&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC&keywords=#goods_list">时间</a></li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'exchange.php?act=asynclist&category=0&brand=&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/huazhuangpin/images/loader.gif" /></div>'})
	$(window).scroll(function () {
