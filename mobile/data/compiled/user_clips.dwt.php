...
<dl class="user_top">
  ...
  <dd>
	...
	<p><a class="link" href="user.php?act=profile">[<?php echo $this->_var['lang']['modify']; ?><?php echo $this->_var['lang']['profile']; ?>]</a><a class="link" style="margin-left:20px;" href="user.php?act=headimg">[修改头像]</a></p>
  </dd>
...
<?php if ($this->_var['action'] == 'qrcode'): ?>
<header id="header">
  <div class="header_l header_return"> <a class="ico_10" href="user.php"> 返回 </a> </div>
  <h1> 我的二维码 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=<?php echo $this->_var['shop_name']; ?>&pic=<?php echo $this->_var['qrcodeimg']; ?>&www=<?php echo $this->_var['shopurl']; ?>index.php?u=<?php echo $this->_var['userid']; ?>"> 分享 </a> </div>
</header>
<table width=100% height=100%><tr><td height=100% align=center valign=middle style="height:300px;"><img src="<?php echo $this->_var['shopurl']; ?><?php echo $this->_var['qrcodeimg']; ?>"></td></tr></table>
<?php endif; ?> 
...
<section class="wrap message_list">
  ...
  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <tr>
        <td> <?php echo $this->_var['lang']['order_number']; ?> <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/huazhuangpin/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
