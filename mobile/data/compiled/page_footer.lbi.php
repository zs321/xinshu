...
<div class="global-nav">
    <div class="global-nav__nav-wrap">
        <div class="global-nav__nav-item">
            <a href="./" class="global-nav__nav-link <?php if ($this->_var['script_name'] == "index"): ?>global-nav__nav-link-cur<?php endif; ?>">
                <i class="global-nav__iconfont global-nav__icon-index">&#xf0001;</i>
                <span class="global-nav__nav-tit">首页</span>
            </a>
        </div>
        <div class="global-nav__nav-item">
            <a href="cat_all.php" class="global-nav__nav-link <?php if ($this->_var['script_name'] == "category"): ?>global-nav__nav-link-cur<?php endif; ?>">
...
<!--        <div class="global-nav__nav-item">
        ...
        <div class="global-nav__nav-item">
            <a href="flow.php?step=cart" class="global-nav__nav-link <?php if ($this->_var['script_name'] == "cart"): ?>global-nav__nav-link-cur<?php endif; ?>">
...
?></span>
        ...
        <div class="global-nav__nav-item">
            <a href="user.php" class="global-nav__nav-link <?php if ($this->_var['script_name'] == "user"): ?>global-nav__nav-link-cur<?php endif; ?>">
