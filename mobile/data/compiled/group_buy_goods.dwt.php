...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <section class="goods_slider">
    ...
    <div id="slideBox" class="slideBox">
      <div class="scroller">
        <ul style="display:block; margin:0 auto; text-align:center; width:100%; height:auto" >
          <li style="text-align:center"><a href="javascript:showPic()"><img alt="<?php echo htmlspecialchars($this->_var['gb_goods']['goods_name']); ?>" src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['gb_goods']['goods_thumb']; ?>"/></a></li>
        </ul>
      </div>
    </div>
    <div class="blank2"></div>
...
<div id="tab1">
    <div class="desc wrap">
      <div class="blank2"></div>
      <?php echo $this->_var['group_buy']['goods_desc']; ?>
    </div>
  </div>
</section>
