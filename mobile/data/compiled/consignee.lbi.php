...
?>
    <option value="<?php echo $this->_var['country']['region_id']; ?>" <?php if ($this->_var['_CFG'] [ 'shop_country' ] == $this->_var['country']['region_id']): ?>selected<?php endif; ?>><?php echo $this->_var['country']['region_name']; ?></option>
...
?>
    ...
    <select name="district" id="selDistricts_<?php echo $this->_var['sn']; ?>" <?php if (! $this->_var['district_list'][$this->_var['sn']]): ?>style="display:none;border:1px solid #ccc; padding:2px;"<?php else: ?>style="border:1px solid #ccc; padding:2px;"<?php endif; ?>>
