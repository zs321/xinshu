...
?> 
        ...
        <div class="desc new-tbl-cell"> <a style="color:#333" href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="fragment">
          ...
          <?php endif; ?>
          <div class="b"> <em class="price"><?php echo $this->_var['goods']['goods_price']; ?></em> <span class="jianju">x </span>  
	...
	<script>
        ...
        {    
          ...
          alert(result.message);
            ...
            <?php else: ?> 
           <span> <?php echo $this->_var['goods']['goods_number']; ?> </span>
            <?php endif; ?> 
             <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; "   class="ico_08 cha"> </a> </div>
        </div>
      </li>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </ul>
	...
	function selcartResponse(res){
	  if (res.err_msg.length > 0){
	     ...
	     document.getElementById('total_number').innerHTML = res.total_number;
	     document.getElementById('goods_subtotal').innerHTML = res.result;
	  }
	}
...
?><br />
                  <div><input type="checkbox" value="<?php echo $this->_var['gift']['id']; ?>" name="gift[]" class="f61" />
                  <a href="goods.php?id=<?php echo $this->_var['gift']['id']; ?>" class="f62"><?php echo $this->_var['gift']['name']; ?><br><?php echo $this->_var['gift']['formated_price']; ?></a></div>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              <?php endif; ?>  
          </td>
        </tr>
...
<footer class="toolbar">
  <span class="selcartgoods"><input type="checkbox" autocomplete="off" id="chkAll" name="chkAll" checked=true  onclick="return chkAll_onclick()"><label for="chkAll">全选</label></span>
  <p>合计: <em class="price" id="goods_subtotal"><?php echo $this->_var['total']['goods_price']; ?></em></p>
  <a onclick="return selcart_submit();">结算(<em class="num" id="total_number"><?php echo $this->_var['total']['total_number']; ?></em>)</a> </footer>
<?php else: ?>
<section class="wrap"  >
...
?>
	   ...
	   <?php endif; ?>
        ...
        <dl class="b_no" style="line-height: 40px;">
		  ...
		  <label for="ECS_NEEDINV"><span class="modRadio fr" style="margin-top: 10px;">
            <i class="fl"></i>
            <ins>否</ins>
         </span></label>
        </dl>
		<div class="dl_box" id="inviype_box" style="margin-bottom:0.5rem; display:none;">
		    ...
		    <input name="need_inv" type="checkbox"  class="input" id="ECS_NEEDINV" onclick="changeNeedInv()" value="1" <?php if ($this->_var['order']['need_inv']): ?>checked="true"<?php endif; ?> style="display:none;" />
                ...
                <dl style="line-height: 40px;">
                    ...
                    <dd><input name="inv_payee" type="text"  class="input" id="ECS_INVPAYEE" size="20" value="<?php echo $this->_var['order']['inv_payee']; ?>" <?php if (! $this->_var['order']['need_inv']): ?>disabled="true"<?php endif; ?> onblur="changeNeedInv()" /></dd>
                </dl>	
                 <dl style="line-height: 40px;">
                    <dd class="c333">
                    发票内容
	...
	<?php endif; ?>
		...
		<div class="dl_box">
		 <dl>
				...
				<dd >	
			<input placeholder="请输入订单备注" id="postscript" name="postscript" type="text"   size="20"  />
				 </dd>
		 </dl>
		</div>	
...
<section class="wrap"> <?php echo $this->smarty_insert_scripts(array('files'=>'utils.js,user.js')); ?> 
  ...
  <div id="leftTabBox" class="loginBox">
    <div class="bd" id="tabBox1-bd" <?php if ($this->_var['action'] == 'register'): ?> style="display:none"<?php endif; ?>>
      <ul>
      <div class="table_box" style="width: 95%;margin: 0 auto">
            <dl>
              <dd>
                 <input type="button" onclick="location.href='user.php?act=login'" value="登录会员中心" class="c-btn3">
              </dd>
            </dl>
            <dl>
              <dd>
                 <input type="button" onclick="location.href='user.php?act=register'" value="还没有会员？立即注册" class="c-btn3">
              </dd>
            </dl>
            <dl>
              <dd>
	  ...
	  <?php if ($this->_var['qq_login'] || $this->_var['weibo_login'] || $this->_var['alipay_login'] || $this->_var['weixin_login']): ?>
          <div class="hezuo">
            ...
            <p class="b">
	      <?php if ($this->_var['qq_login']): ?><a href="user.php?act=oath&type=qq"><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/quicklogin/qq.png"></a> <?php endif; ?>
	      <?php if ($this->_var['weibo_login']): ?><a href="user.php?act=oath&type=weibo"><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/quicklogin/weibo.png"></a> <?php endif; ?>
	      <?php if ($this->_var['alipay_login']): ?><a href="user.php?act=oath&type=alipay"><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/quicklogin/zhifubao.png"></a> <?php endif; ?>
	      <?php if ($this->_var['is_wechat_browser'] && $this->_var['weixin_login']): ?><a href="user.php?act=oath&type=weixin"><img src="<?php echo $this->_var['ectouch_themes']; ?>/images/quicklogin/weixin.png"></a><?php endif; ?>
	    </p>
          </div>
	  <?php endif; ?>
        </div>
	...
	<li style="line-height:10rem;text-align:center;font-size:1.5rem;color:red;"><?php echo $this->_var['lang']['shop_register_closed']; ?></li>
      <?php else: ?>
