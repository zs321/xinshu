...
?>
    ...
    <td align="center" nowrap="true"><span>
      <a href="wxch_keywords.php?act=edit<?php if ($this->_var['list']['type'] == 1): ?>&type=text<?php else: ?>&type=image<?php endif; ?>&id=<?php echo $this->_var['list']['id']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" width="21" height="21" /></a>&nbsp;
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['id']; ?>, '您确认要删除这个规则吗？')" title="移除"><img src="images/icon_drop.gif" border="0" width="21" height="21"></a><!--  --></span>
    </td>
   </tr>
