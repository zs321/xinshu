...
<style>
            ...
            div.ad_img img:hover{  
                transform: scale(10);  
            }  
</style>
<!-- 青蜂网络修改增加代码start -->
<div class="form-div">
  <form action="javascript:searchAd()" name="searchForm">
    <img src="images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
	按广告位置名称： <input type="text" name="ad_p" size="30" />
	按广告名称： <input type="text" name="ad_n" size="30" />
    按广告ID： <input type="text" name="ad_i" size="5" />
...
<script language="JavaScript">
    function searchAd()
    {
		listTable.filter['ad_i'] = document.forms['searchForm'].elements['ad_i'].value;
        listTable.filter['ad_n'] = Utils.trim(document.forms['searchForm'].elements['ad_n'].value);
		listTable.filter['ad_p'] = Utils.trim(document.forms['searchForm'].elements['ad_p'].value);
...
<div style="float:left;margin-right:10px;line-height:40px; color:#FF0000">【<?php echo $this->_var['list']['type']; ?>】</div> 
<?php if (( $this->_var['list']['type'] == '图片' )): ?> 
<div class="ad_img"> 
<a href="<?php if (strpos ( $this->_var['list']['ad_code'] , 'www' )): ?><?php echo $this->_var['list']['ad_code']; ?><?php else: ?>../data/afficheimg/<?php echo $this->_var['list']['ad_code']; ?><?php endif; ?>" target="_blank"><img style="border:none" <?php if (strpos ( $this->_var['list']['ad_code'] , 'www' )): ?>src="<?php echo $this->_var['list']['ad_code']; ?>"<?php else: ?>src="../data/afficheimg/<?php echo $this->_var['list']['ad_code']; ?>" <?php endif; ?> height="40px" /></a>
</div> 
<?php endif; ?> 

<?php if (( $this->_var['list']['type'] == '文字' )): ?> 
<div style="float:left;height:40px;max-width:200px;*width:200px;overflow:hidden;"> 
<?php echo $this->_var['list']['ad_code']; ?>
</div> 
<?php endif; ?> 
</span></td>
