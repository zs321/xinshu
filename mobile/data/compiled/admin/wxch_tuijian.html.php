...
?>
    ...
    <td align="center" nowrap="true"><span>
      ...
      <a href="wxch_tuijian.php?act=edit<?php if ($this->_var['list']['type_name'] == QR_SCENE): ?>&type=scent<?php else: ?>&type=limit<?php endif; ?>&id=<?php echo $this->_var['list']['qid']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" width="21" height="21" /></a>&nbsp;
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['qid']; ?>, '您确认要删除吗？')" title="移除"><img src="images/icon_drop.gif" border="0" width="21" height="21"></a><!--  --></span>
    </td>
   </tr>
