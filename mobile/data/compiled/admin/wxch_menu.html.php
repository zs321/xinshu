    ...
    <tr>
        ...
        <td>
            ...
            <select name="first_type[]">
                    ...
                    <option value="click"<?php if ($this->_var['data']['first']['0']['menu_type'] == click): ?>selected<?php endif; ?> >点击事件</option>

                    <option value="view" <?php if ($this->_var['data']['first']['0']['menu_type'] == view): ?>selected<?php endif; ?> >跳转网址</option>
        ...
        <td>
                ...
                <label><input type="text" name="first[]" value="<?php echo $this->_var['data']['first']['0']['name']; ?>" size="80"/></label>

        </td>

        <td>

                <label><input type="text" name="first_value[]" value="<?php echo $this->_var['data']['first']['0']['value']; ?>" size="80"/></label>
    ...
    <tr>
        ...
        <td>
            ...
            <select name="menu_type1[]">
                    ...
                    <option value="click" <?php if ($this->_var['items']['menu_type'] == click): ?>selected<?php endif; ?> >点击事件</option>

                    <option value="view" <?php if ($this->_var['items']['menu_type'] == view): ?>selected<?php endif; ?> >跳转网址</option>
        ...
        <td>
                ...
                <label><input type="text" name="second1[]" value="<?php echo $this->_var['items']['name']; ?>" size="80"/></label>

        </td>

        <td>

                <label><input type="text" name="value1[]" value="<?php echo $this->_var['items']['value']; ?>" size="80"/></label>
    ...
    <tr>
        ...
        <td>
            ...
            <select name="first_type[]">
                    ...
                    <option value="click"<?php if ($this->_var['data']['first']['1']['menu_type'] == click): ?>selected<?php endif; ?> >点击事件</option>

                    <option value="view" <?php if ($this->_var['data']['first']['1']['menu_type'] == view): ?>selected<?php endif; ?> >跳转网址</option>
        ...
        <td>
                ...
                <label><input type="text" name="first[]" value="<?php echo $this->_var['data']['first']['1']['name']; ?>" size="80"/></label>

        </td>

        <td>

                <label><input type="text" name="first_value[]" value="<?php echo $this->_var['data']['first']['1']['value']; ?>" size="80"/></label>
...
?>
    ...
    <tr>
        ...
        <td>
                ...
                <label><input type="text" name="second2[]" value="<?php echo $this->_var['items']['name']; ?>" size="80"/></label>

        </td>

        <td>

                <label><input type="text" name="value2[]" value="<?php echo $this->_var['items']['value']; ?>" size="80"/></label>
    ...
    <tr>
        ...
        <td>
            ...
            <select name="first_type[]">
                    ...
                    <option value="click"<?php if ($this->_var['data']['first']['2']['menu_type'] == click): ?>selected<?php endif; ?> >点击事件</option>
                    <option value="view" <?php if ($this->_var['data']['first']['2']['menu_type'] == view): ?>selected<?php endif; ?> >跳转网址</option>
            </select>  
        ...
        <td>
                ...
                <label><input type="text" name="first[]" value="<?php echo $this->_var['data']['first']['2']['name']; ?>" size="80"/></label>

        </td>

        <td>

                <label><input type="text" name="first_value[]" value="<?php echo $this->_var['data']['first']['2']['value']; ?>" size="80"/></label>
...
?>
    ...
    <tr>
        ...
        <td>
                ...
                <label><input type="text" name="second3[]" value="<?php echo $this->_var['items']['name']; ?>" size="80"/></label>

        </td>

        <td>

                <label><input type="text" name="value3[]" value="<?php echo $this->_var['items']['value']; ?>" size="80"/></label>
