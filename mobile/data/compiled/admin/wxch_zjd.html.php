...
?>
    ...
    <td align="center" nowrap="true"><span>
     <?php if ($this->_var['list']['register'] == 1): ?><a href="wxch_zjd.php?act=view&id=<?php echo $this->_var['list']['id']; ?>&wxid=<?php echo $this->_var['list']['wxid']; ?>" title="查看联系方式" ><img src="images/icon_view.gif" border="0" width="21" height="21" /></a><?php endif; ?>
     <?php if ($this->_var['wxch_ver'] == 1): ?><a href="wxch_users.php?act=send&wxid=<?php echo $this->_var['list']['wxid']; ?>" title="联系中奖粉丝" ><img src="images/icon_title.gif" border="0" width="21" height="21" /></a><?php endif; ?>
     <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['id']; ?>, '您确认要删除这个中奖记录吗？')" title="移除"><img src="images/icon_drop.gif" border="0" width="21" height="21"></a><!--  --></span>
    </td>
   </tr>
