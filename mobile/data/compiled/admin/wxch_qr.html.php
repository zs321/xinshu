...
?>
    ...
    <td align="center" nowrap="true"><span>
      <a href="<?php echo $this->_var['list']['qr_path']; ?>" target="_blank" title="查看"><img src="images/icon_view.gif" width="21" height="21" border="0" /></a>
      <a href="wxch_qr.php?act=edit<?php if ($this->_var['list']['type_name'] == QR_SCENE): ?>&type=scent<?php else: ?>&type=limit<?php endif; ?>&id=<?php echo $this->_var['list']['qid']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" width="21" height="21" /></a>&nbsp;
     <!--  --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['qid']; ?>, '您确认要删除这个二维码吗？')" title="移除"><img src="images/icon_drop.gif" border="0" width="21" height="21"></a><!--  --></span>
    </td>
   </tr>
