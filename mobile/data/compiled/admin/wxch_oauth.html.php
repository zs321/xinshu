...
?>
    ...
    <td align="center" nowrap="true"><span>
      <a href="wxch_oauth.php?act=edit&oid=<?php echo $this->_var['list']['oid']; ?>" title="编辑"><img src="images/icon_edit.gif" border="0" width="21" height="21" /></a>&nbsp;
     <!--  --><a href="#" onclick="listTable.remove(<?php echo $this->_var['list']['oid']; ?>, '您确认要删除这个规则吗？')" title="移除"><img src="images/icon_drop.gif" border="0" width="21" height="21"></a><!--  --></span>
    </td>
   </tr>
