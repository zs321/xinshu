...
<table cellpadding="3" cellspacing="1">
	<tr>
        ...
        <th><?php echo $this->_var['lang']['website_www']; ?></th>
...
?>
    <tr align="center">
        ...
        <td><?php echo $this->_var['val']['www']; ?></td>
        ...
        <td><?php if (! $this->_var['val']['install']): ?><a href="website.php?act=install&type=<?php echo $this->_var['val']['type']; ?>"><?php echo $this->_var['lang']['install']; ?></a><?php else: ?>
        	<a href="website.php?act=view&type=<?php echo $this->_var['val']['type']; ?>"><?php echo $this->_var['lang']['edit']; ?></a>
