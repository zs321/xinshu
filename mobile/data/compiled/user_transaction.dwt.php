...
?>
            	...
            	<?php if ($this->_var['item']['extension_code'] != 'pre_sale' || $this->_var['item']['pre_sale_status'] > 1): ?>
                    ...
                    <?php if ($this->_var['goods']['back_can'] == 1): ?> <a href="user.php?act=back_order&order_id=<?php echo $this->_var['item']['order_id']; ?>&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&product_id=<?php echo $this->_var['goods']['product_id']; ?>&x=1" class="order_btn" >申请退款</a><br />
                    <?php else: ?>
                    <p>[已申请 退款]</p>
                    <?php endif; ?> 
                    <?php endif; ?> 
                    ...
                    <p> <a href="user.php?act=back_order&order_id=<?php echo $this->_var['item']['order_id']; ?>&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>&product_id=<?php echo $this->_var['goods']['product_id']; ?>" class="order_btn"> <?php if ($this->_var['item']['shipping_status'] == 1): ?>
                      申请退货
                      <?php else: ?>
              ...
              <tr class="order-bd">
                <td align="right" class="other">
                  ...
                  <a href="user.php?act=order_detail&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="order_btn">立即付款</a>
                  <?php endif; ?> 
                  <?php endif; ?> 
		  ...
		  <?php if ($this->_var['item']['shipping_status'] == 2 || $this->_var['item']['order_status1'] == 2 || $this->_var['item']['order_status1'] == 3): ?> 
                  <a href="goods.php?id=<?php echo $this->_var['item']['goods_list']['0']['goods_id']; ?>" class="order_btn">再次购买</a> 
                  <?php endif; ?>
		  <?php if ($this->_var['item']['invoice_no'] && $this->_var['item']['shipping_name'] != '上门取货' && $this->_var['item']['shipping_name'] != '城际快递' && $this->_var['item']['shipping_name'] != '市内快递' && $this->_var['item']['shipping_name'] != '运费到付'): ?><a href="user.php?act=order_tracking&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="order_btn">查看物流</a><?php endif; ?>
		  <a href="user.php?act=order_detail&order_id=<?php echo $this->_var['item']['order_id']; ?>" class="order_btn">查看详情</a>
                  </td>
              </tr>
            </tbody>
          </table>
    ...
    <header id="header">
      <div class="c-inav">
        <section>
          <button class="back">
          <span><em></em></span><a href="user.php">返回</a>
          </button>
        </section>
...
?>
          <tr>
            ...
            <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="/<?php echo $this->_var['goods']['goods_thumb']; ?>" width="60" height="60" /></a></td>
...
?>
      ...
      <form name="formSurplus" method="post" action="user.php" onSubmit="return submitSurplus()">
        <table width="100%" border="0" cellpadding="5" cellspacing="1" >
          ...
          <tr>
            <td align="left" ><input placeholder="开户银行/支付宝/微信" type="text" name="bank_name"  style="border-radius:3px;margin-bottom:10px;" class="inputBg" size="30" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="left" ><textarea  style="width:97%;height:80px;border:1px solid #ddd;border-radius:3px;line-height:35px;color:#666;padding-left:3%;color: #333;font-family:微软雅黑;" placeholder="会员备注！" name="user_note" cols="55" rows="6"  class="B_blue"></textarea></td>
          </tr>
        </table>
      ...
      <form name="formSurplus" method="post" action="user.php" onSubmit="return submitSurplus()">
        <table width="100%" border="0" cellpadding="5" cellspacing="1" >
          ...
          <tr>
            <td align="left" ><textarea  style="width:97%;height:80px;border:1px solid #ddd;border-radius:3px;line-height:35px;color:#666;padding-left:3%;color: #333;font-family:微软雅黑;" placeholder="留言备注！" name="user_note" cols="55" rows="6"  class="B_blue"><?php echo htmlspecialchars($this->_var['order']['user_note']); ?></textarea></td>
          </tr>
        </table>
		...
		if (document.getElementById("back_type_2").checked == true || document.getElementById("back_type_3").checked == true)
		{
          ...
          <form action="user.php?act=back_order_act" name="theForm" id="theForm" method="post" onsubmit="return check_back_form();">
            <table class="tablecss2" width="100%" border="0" cellpadding="5" cellspacing="1">
              <tr>
                <td width="30%" align="left">订单编号：</td><td bgcolor="#FFFFFF"><?php echo $this->_var['back_goods']['order_sn']; ?></td>
              </tr>
              <tr>
                <td align="left">商品名称：</td><td bgcolor="#FFFFFF"><?php echo $this->_var['back_goods']['goods_name']; ?></td>
              </tr>
	      <?php if ($this->_var['back_goods']['goods_attr']): ?>
              <tr>
                <td align="left">商品属性：</td><td bgcolor="#FFFFFF"><?php echo $this->_var['back_goods']['goods_attr']; ?></td>
              </tr>
	      <?php endif; ?>
              <tr>
                <td align="left">商品价格：</td><td bgcolor="#FFFFFF"><?php echo $this->_var['back_goods']['goods_price_format']; ?></td>
              </tr>
              <tr>
                <td align="left">购买数量：</td><td bgcolor="#FFFFFF"><?php echo $this->_var['back_goods']['goods_number']; ?></td>
              </tr>
              <tr>
                <td align="left">费用小计：</td><td bgcolor="#FFFFFF"><?php echo $this->_var['back_goods']['total_price_format']; ?></td>
              </tr>
            </table>
            <table class="tablecss2" width="100%" border="0" cellpadding="5" cellspacing="1" >
              <tr>
                <td width="30%" align="left">服务类型：</td>
        <td>
...
?> 
              ...
              <tr>
                <td width="30%" align="left" valign=top>提交数量：</td>
                <td><script>
			function check_tui_goods_number()
			{
				...
				else if (now_number > goods_number)
				{
                  ...
                  <input type="text" style=" min-width:100px; line-height:20px; border:solid 1px #DDD; height:20px; text-align:center" name="tui_goods_number" id="tui_goods_number" onblur="check_tui_goods_number()" value="1" size=5></td>
              </tr>
              <tr>
                <td align="left" valign=top>问题描述：</td>
                <td style="height:auto;"><textarea style="width:80%" name="back_reason" id="back_reason" rows=5></textarea>
                  <font color=#ff3300>*</font>
                  <div style="color:#999">请您如实填写申请原因及商品情况，字数在500字内。</div></td>
              </tr>
              <tr>
                <td align="left" valign=top>图片信息：</td>
    ...
    <?php endif; ?>
                <td align="left" valign=top>退款方式：</td>
...
?>
              ...
              <tr>
                <td align="left" >我要留言：</td>
                <td style="height:auto; padding:0px 5px;"><textarea style="width:80%" name="back_postscript" rows=5></textarea></td>
              </tr>
              <tr>
