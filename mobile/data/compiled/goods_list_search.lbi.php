      ...
      <div id="more_element_1" class="product flex_in single_item">
        <div class="pro-inner">
          ...
          <div class="proInfo-wrap">
            ...
            <div class="proSales">已售出:<em><span class="sales"><?php echo $this->_var['goods']['sales_count']; ?></span></em></div>
            <a href="javascript:;" onclick="categoryaddToCart2(<?php echo $this->_var['goods']['goods_id']; ?>)" class="catbuybtn"></a>
          </div>
        </div>
      </div>
      <?php endif; ?> 
