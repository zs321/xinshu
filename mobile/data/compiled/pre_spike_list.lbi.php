...
?> 
      ...
      <div class="product flex_in single_item">
        <div class="pro-inner">
          <div class="proImg-wrap"> <a href="<?php echo $this->_var['pre_spike']['url']; ?>" style="display:block;font-size:0px;"> <img src="/<?php echo $this->_var['pre_spike']['goods_thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['pre_spike']['goods_name']); ?>"> </a> </div>
