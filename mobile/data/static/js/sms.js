...
function getverifycode1(field_id, field_name) {
	...
	{
		$.post('sms.php?step=getverifycode1&r=' + Math.random(), { 'mobile': mobile},getverifycode1Response, "json");
	}
}
...
function getverifycode2() {
	...
	{
		$.post('sms.php?step=getverifycode2&r=' + Math.random(), { 'mobile': mobile},getverifycode2Response, "json");
	}
}
