...
if ($_GET['act'] == 'asynclist') {
    ...
    if (is_array($list)) {
        ...
        <tr>
          ...
          <td width="75%" bgcolor="#ffffff" align="left" style="color:#ff0000;font-weight: bold;">' . $val['act_name'] . '</td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="15%" bgcolor="#ffffff" align="right">' . $_LANG['label_max_amount'] . '</td>
          <td width="35%" bgcolor="#ffffff" align="left">' . $max_amount . '</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td bgcolor="#ffffff" align="left"> '. $val['act_range'] .$extends.'</td>
        </tr>
        <tr>
