...
class cls_session
{
    ...
    function destroy_session()
    {
        ...
        {
            //$this->db->query('DELETE FROM ' . $GLOBALS['ecs']->table('cart') . " WHERE session_id = '$this->session_id'");//青蜂网络www.0769web.net购物车选择性结算注释
            $this->db->query('DELETE FROM ' . $GLOBALS['ecs']->table('cart') . " WHERE session_id = '$this->session_id' AND user_id = 0");//新增青蜂网络www.0769web.net购物车选择性结算
        }
        /* ECSHOP 鑷?畾涔夋墽琛岄儴鍒 */
