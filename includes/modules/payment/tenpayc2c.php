...
class tenpayc2c
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button  = '<form action="https://www.tenpay.com/cgi-bin/med/show_opentrans.cgi " >';
        ...
        $button  .= '<input class="btn-buy-cart" type="submit" name="submit" value="' .$GLOBALS['_LANG']['pay_button']. '" /></form>';
