...
class cappay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $def_url  = '<form method=post action="http://pay.beijing.com.cn/prs/user_payment.checkit">';
        ...
        $def_url .= "<input class='btn-buy-cart' type='submit' value='" . $GLOBALS['_LANG']['cappay_button'] . "'>";
